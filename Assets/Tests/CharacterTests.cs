...
public class CharacterTests : InputTestFixture
{
   ...
   [Test]
    ...
    public IEnumerator TestPlayerFallDamage()
    {
        ...
        //health(1f)
       var characterHealth = characterInstance.GetComponent<StarterAssets.PlayerHealth>();
        Assert.That(characterHealth.Health, Is.LessThan(1f));
        ...
        Assert.That(characterHealth.Health, Is.LessThan(0.9f));
    }
